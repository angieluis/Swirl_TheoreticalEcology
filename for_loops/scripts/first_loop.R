...
# For example, when i is 1, 1^2 or 1 will be saved to the first spot in the 
# out vector (out[1]). Then the next time through the loop, i will be 2, and 2^2 or 4
# will be saved to the second spot in the out vector (out[2]). And so on.
for(i in 1:10){
   #out[i] <- i^2
}
